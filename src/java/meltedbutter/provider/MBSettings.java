...
public class MBSettings {
    ...
    /**
     * Location of the pie in the screen 0 = Gravity.LEFT 1 = Gravity.TOP 2 =
     * Gravity.RIGHT 3 = Gravity.BOTTOM (default)
     * 
     * @hide
     */
    ...
    /**
     * Whether to use a separate delay for "slide to unlock" and security lock
